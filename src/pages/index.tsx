  ...
  const mint = async () => {
    ...
    try {
      ...
      if (e.code === 'UNSUPPORTED_OPERATION') {
        toast({
          title: "CAN'T MINT",
          description: "You are not the owner of this NFT contract, therefore you can't call the mint function.",
          status: 'error',
          duration: 9000,
          isClosable: true,
        })
    ...
    <>
      ...
      <main>
        ...
        <p>
          ...
          <strong> {userBal}</strong>. Just click on the &apos;Mint&apos; button below: you will be invited to sign your transaction: you will mint 3
          different NFTs.{' '}
        </p>
        <br />
        {!isContractOwner ? (
